...
class ElementSelector:
    ...
    """登录页面"""
    user_login_btn_loc = '//span[text()="登录/注册"]'  # '首页登录按钮'
    ...
    standard_mode_btn_loc = '//div[@class="course-hw"]/div[1]'  # '标准授课发布课件作业按钮'
    subject_mode_btn_loc = '//div[@class="course-hw"]/div[2]'  # '主题授课发布课件作业按钮'

    """首页统计栏课件作业"""
    index_course_name_loc = \
        '//div[@class="home-stu-course-container clearfix"]/div[1]/div/div/div[1]'  # '学生端首页最新课程课程名称'
    ...
    # first_course_loc = \
    #     '//div[@class="course-container-gird"]/ul/li[1]/div/div/div[2]/div[1]/div'  # '课件详情列表第一个课件'
    homework_list_loc = \
    ...
    checkpoint_choice_problem_loc = ''  # '选择题'  # 待定
    checkpoint_operation_problem_loc = ''  # '操作题'  # 待定
    ...
    problem_list_loc = '//div[@class="data-back-single-title fl"]'  # '题目列表'  # 待定
    ...
    save_run_btn_loc = '//div[contains(text(),"运行")]'  # '保存并运行按钮'
    pass_result_text_loc = '//div[@class="code-result-des active"]'  # '评测通过文本'
    unpass_result_text_loc = '//div[@class="code-result-des"]'  # '评测不通过文本'
    ...
    pygame_canvas_loc = By.ID  # 'myPygameCanvas'#'pygame弹窗'
